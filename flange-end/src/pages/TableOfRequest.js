...
class TableOfRequest extends Component {
    reqest_number = "";
    constructor(props) {
        super(props);
        this.state = {
        ...
        this.GetTableOfRequest = this.GetTableOfRequest.bind(this);
    ...
    async YesFunc(ReqNum) {
        const send_obj = {
            'method': 'get',
            'url': this.props.server + 'confirm/confirmcancelrequest',
    ...
    async GetTableOfRequest() {
        let url = '';
        const send_obj = {
            'method': 'get',
            'url': this.props.server + 'getdata/gettableofrequest',
    ...
    render() {
        switch (this.state.SubPage) {
            ...
            case 'detail': {
                return (<DetailOfRequest progress={this.props.progress} 
                server={this.props.server} request_code={this.reqest_number} />);
                break;
            }
            default: {
                //statements; 
